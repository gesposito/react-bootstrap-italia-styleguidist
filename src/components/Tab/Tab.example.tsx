...
class TabExample extends React.Component<PropsType, StateType> {
        ...
        <Nav tabs className="mb-3">
          <NavItem>
            <NavLink href="#" active={this.state.activeTab === "1"} onClick={() => {
              ...
              {(() => {
                if (icons) {
                  return <i className="it-ico-lg it-file d-block text-center" />;
                }
                return null;
              })()}
              {(() => {
          ...
          <NavItem>
            <NavLink href="#" active={this.state.activeTab === "2"} onClick={() => {
              ...
              {(() => {
                if (icons) {
                  return <i className="it-ico-lg it-calendar d-block text-center" />;
                }
                return null;
              })()}
              {(() => {
          ...
          <NavItem>
            <NavLink href="#" active={this.state.activeTab === "3"} onClick={() => {
              ...
              {(() => {
                if (icons) {
                  return <i className="it-ico-lg it-comment d-block text-center" />;
                }
                return null;
              })()}
              {(() => {
